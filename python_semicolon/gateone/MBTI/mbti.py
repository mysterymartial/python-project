...
def get_first_response(reponses):
	...
	fourth = reponses[12]
	fifth = reponses[16]
	new_responses = [ first, second, third, fourth, fifth]
	for element in new_responses:
		if element == "A":
...
def get_second_response(reponses):
	counter_A = 0;
	counter_B = 0;
	first = reponses[1]
	second = reponses[5]
...
def get_third_response(reponses):
	counter_A = 0
	counter_B = 0
	first = reponses[2]
	second = reponses[6]
...
def get_fourth_response(reponses):
	counter_A = 0
	counter_B = 0
	first = reponses[3]
	second = reponses[7]
...
def get_personality( first,  second,  third,  fourth):
		
	personality = first +  second +  third +  fourth 
	if personality == "ISTJ": 
